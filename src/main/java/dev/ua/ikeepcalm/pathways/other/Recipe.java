package dev.ua.ikeepcalm.pathways.other;
...
public class Recipe {
    ...
    public ItemStack getRecipeForSequence(Potion potion, int sequence) {
        ...
        bookMeta.setDisplayName(potion.getStringColor() + GeneralPurposeUtil.capitalize(potion.getName()) + "-Pathway Sequence " + sequence);
