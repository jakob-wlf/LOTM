...
public class FriendlySpirit extends Spirit {
    ...
    public FriendlySpirit(LivingEntity entity, double health, float particleOffset, int spawnRate, boolean hostile, boolean visible) {
        super(entity, health, particleOffset, spawnRate, hostile, visible);
    }

    @Override
    public Spirit initNew(LivingEntity entity) {
        return new FriendlySpirit(entity, health, particleOffset, spawnRate, hostile, visible);
    }
