...
public class BeyonderMobsHandler implements Listener {
    ...
    public BeyonderMobsHandler() {
        ...
        spawnEntity("§7Ancient Wraith", "wraith", 250, BeyonderItems.getWraithDust(), EntityType.SKELETON, 85, beyonderMobs, EntityType.VEX);
        spawnEntity("§5Six Winged Gargoyle", "gargoyle", 300, BeyonderItems.getGargoyleCrystal(), EntityType.ZOMBIE, 120, beyonderMobs, EntityType.IRON_GOLEM);
        spawnEntity("§5Bizarro Bane", "bane", 100, BeyonderItems.getBizarroEye(), EntityType.WITCH, 120, beyonderMobs, EntityType.ALLAY);
        spawnEntity("§5Spirit World Plunderer", "plunderer", 500, BeyonderItems.getPlundererBody(), EntityType.ZOMBIFIED_PIGLIN, 150, beyonderMobs, EntityType.VEX);
